    ...
    <div class="login-box">
        ...
        <form class="sky-form boxed pricing-table popular">
            ...
            <header class="text-center">
                ...
                <p class="size-15 margin-bottom-10">{{ $messageError }}</p>
                <small class="note bold size-20" data-toggle="popover" data-placement="bottom" title="{{ $error }}">
            ...
            <fieldset>  
                <section class="text-center">
                    ...
                    <small class="note bold">{{ $message }}</small>
                </section>
            </fieldset>
        </form>
        <hr/>
